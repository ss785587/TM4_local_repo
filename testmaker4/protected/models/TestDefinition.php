...
class TestDefinition extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('created, startTime, endTime', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('idTestDefinition, name, version, probability, maxNum, currentNum, currentNumFinished, allowServeralTimes, created, startTime, endTime, active, uberTestId', 'safe', 'on'=>'search'),
		);
	}
