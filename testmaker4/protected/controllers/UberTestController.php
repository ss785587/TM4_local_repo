...
class UberTestController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','view','startTest'),
				'users'=>array('@'),
			),
	...
	public function actionIndex()
	{
		...
		Yii::import('application.controllers.TestDefinitionController');
		...
		foreach($uberTestIds as $id){
			array_push($dataProvider, $this->loadModel($id));
		}
	...
	public function actionStartTest($id){
		Yii::import('application.controllers.TestDefinitionController');
		$testDefContr = new TestDefinitionController('TestDefinitionController');
		$uberTestIds = $testDefContr->getRunnableTestDefinition($id);
		print_r($uberTestIds);
	}
